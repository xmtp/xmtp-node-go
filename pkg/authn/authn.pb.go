...
func (x *PublicKey) GetSecp256K1Uncompressed() *Secp256K1Uncompresed {
	if x != nil {
		if x, ok := x.Union.(*PublicKey_Secp256K1Uncompressed); ok {
...
func (x *ClientAuthRequest) GetV1() *V1ClientAuthRequest {
	if x != nil {
		if x, ok := x.Version.(*ClientAuthRequest_V1); ok {
			return x.V1
		}
	}
	return nil
...
func (x *ClientAuthResponse) GetV1() *V1ClientAuthResponse {
	if x != nil {
		if x, ok := x.Version.(*ClientAuthResponse_V1); ok {
			return x.V1
		}
	}
	return nil
...
const file_authn_proto_rawDesc = "" +
	"\n" +
	"\vauthn.proto\x12\x02pb\"\x99\x01\n" +
	"\tSignature\x12A\n" +
	"\recdsa_compact\x18\x01 \x01(\v2\x1a.pb.Signature.ECDSACompactH\x00R\fecdsaCompact\x1a@\n" +
	"\fECDSACompact\x12\x14\n" +
	"\x05bytes\x18\x01 \x01(\fR\x05bytes\x12\x1a\n" +
	"\brecovery\x18\x02 \x01(\rR\brecoveryB\a\n" +
	"\x05union\",\n" +
	"\x14Secp256k1Uncompresed\x12\x14\n" +
	"\x05bytes\x18\x01 \x01(\fR\x05bytes\"\xc5\x01\n" +
	"\tPublicKey\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x04R\ttimestamp\x120\n" +
	"\tsignature\x18\x02 \x01(\v2\r.pb.SignatureH\x01R\tsignature\x88\x01\x01\x12Q\n" +
	"\x16secp256k1_uncompressed\x18\x03 \x01(\v2\x18.pb.Secp256k1UncompresedH\x00R\x15secp256k1UncompressedB\a\n" +
	"\x05unionB\f\n" +
	"\n" +
	"_signature\"\xdb\x01\n" +
	"\x13V1ClientAuthRequest\x12,\n" +
	"\x12identity_key_bytes\x18\x01 \x01(\fR\x10identityKeyBytes\x128\n" +
	"\x10wallet_signature\x18\x02 \x01(\v2\r.pb.SignatureR\x0fwalletSignature\x12&\n" +
	"\x0fauth_data_bytes\x18\x03 \x01(\fR\rauthDataBytes\x124\n" +
	"\x0eauth_signature\x18\x04 \x01(\v2\r.pb.SignatureR\rauthSignature\"I\n" +
	"\x11ClientAuthRequest\x12)\n" +
	"\x02v1\x18\x01 \x01(\v2\x17.pb.V1ClientAuthRequestH\x00R\x02v1B\t\n" +
	"\aversion\"\\\n" +
	"\x14V1ClientAuthResponse\x12'\n" +
	"\x0fauth_successful\x18\x01 \x01(\bR\x0eauthSuccessful\x12\x1b\n" +
	"\terror_str\x18\x02 \x01(\tR\berrorStr\"K\n" +
	"\x12ClientAuthResponse\x12*\n" +
	"\x02v1\x18\x01 \x01(\v2\x18.pb.V1ClientAuthResponseH\x00R\x02v1B\t\n" +
	"\aversion\"b\n" +
	"\bAuthData\x12\x1f\n" +
	"\vwallet_addr\x18\x01 \x01(\tR\n" +
	"walletAddr\x12\x17\n" +
	"\apeer_id\x18\x02 \x01(\tR\x06peerId\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\x04R\ttimestampB\tZ\a.;authnb\x06proto3"

var (
	file_authn_proto_rawDescOnce sync.Once
	file_authn_proto_rawDescData []byte
)

func file_authn_proto_rawDescGZIP() []byte {
	file_authn_proto_rawDescOnce.Do(func() {
		file_authn_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_authn_proto_rawDesc), len(file_authn_proto_rawDesc)))
	})
	return file_authn_proto_rawDescData
}

var file_authn_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_authn_proto_goTypes = []any{
...
func file_authn_proto_init() {
	...
	file_authn_proto_msgTypes[0].OneofWrappers = []any{
		(*Signature_EcdsaCompact)(nil),
	}
	file_authn_proto_msgTypes[2].OneofWrappers = []any{
		(*PublicKey_Secp256K1Uncompressed)(nil),
	}
	file_authn_proto_msgTypes[4].OneofWrappers = []any{
		(*ClientAuthRequest_V1)(nil),
	}
	file_authn_proto_msgTypes[6].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_authn_proto_rawDesc), len(file_authn_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
