...
type mockConstructorTestingTNewMockMlsApi_SubscribeGroupMessagesServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockMlsApi_SubscribeGroupMessagesServer(t mockConstructorTestingTNewMockMlsApi_SubscribeGroupMessagesServer) *MockMlsApi_SubscribeGroupMessagesServer {
