...
type mockConstructorTestingTNewMockMlsApi_SubscribeWelcomeMessagesServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockMlsApi_SubscribeWelcomeMessagesServer(t mockConstructorTestingTNewMockMlsApi_SubscribeWelcomeMessagesServer) *MockMlsApi_SubscribeWelcomeMessagesServer {
