...
// ValidateV3KeyPackages provides a mock function with given fields: ctx, keyPackages
func (_m *MockMLSValidationService) ValidateV3KeyPackages(ctx context.Context, keyPackages [][]byte) ([]mlsvalidate.IdentityValidationResult, error) {
	ret := _m.Called(ctx, keyPackages)

	if len(ret) == 0 {
		panic("no return value specified for ValidateV3KeyPackages")
	}

	var r0 []mlsvalidate.IdentityValidationResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, [][]byte) ([]mlsvalidate.IdentityValidationResult, error)); ok {
		return rf(ctx, keyPackages)
	}
	if rf, ok := ret.Get(0).(func(context.Context, [][]byte) []mlsvalidate.IdentityValidationResult); ok {
		r0 = rf(ctx, keyPackages)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]mlsvalidate.IdentityValidationResult)
		}
	}
...
// MockMLSValidationService_ValidateV3KeyPackages_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ValidateV3KeyPackages'
type MockMLSValidationService_ValidateV3KeyPackages_Call struct {
	*mock.Call
}

// ValidateV3KeyPackages is a helper method to define mock.On call
//   - ctx context.Context
//   - keyPackages [][]byte
func (_e *MockMLSValidationService_Expecter) ValidateV3KeyPackages(ctx interface{}, keyPackages interface{}) *MockMLSValidationService_ValidateV3KeyPackages_Call {
	return &MockMLSValidationService_ValidateV3KeyPackages_Call{Call: _e.mock.On("ValidateV3KeyPackages", ctx, keyPackages)}
}

func (_c *MockMLSValidationService_ValidateV3KeyPackages_Call) Run(run func(ctx context.Context, keyPackages [][]byte)) *MockMLSValidationService_ValidateV3KeyPackages_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([][]byte))
	})
	return _c
...
func (_c *MockMLSValidationService_ValidateV3KeyPackages_Call) Return(_a0 []mlsvalidate.IdentityValidationResult, _a1 error) *MockMLSValidationService_ValidateV3KeyPackages_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMLSValidationService_ValidateV3KeyPackages_Call) RunAndReturn(run func(context.Context, [][]byte) ([]mlsvalidate.IdentityValidationResult, error)) *MockMLSValidationService_ValidateV3KeyPackages_Call {
	_c.Call.Return(run)
	return _c
}
