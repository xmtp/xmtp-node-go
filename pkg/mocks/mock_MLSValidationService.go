...
type mockConstructorTestingTNewMockMLSValidationService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockMLSValidationService(t mockConstructorTestingTNewMockMLSValidationService) *MockMLSValidationService {
