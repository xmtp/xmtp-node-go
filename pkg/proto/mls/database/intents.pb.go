...
func (x *UpdatePermissionData) GetV1() *UpdatePermissionData_V1 {
	if x, ok := x.GetVersion().(*UpdatePermissionData_V1_); ok {
		return x.V1
	}
	return nil
}
...
var file_mls_database_intents_proto_rawDesc = []byte{
	...
	0x4e, 0x4c, 0x59, 0x10, 0x04, 0x42, 0xc0, 0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x78, 0x6d,
	...
	0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x78, 0x6d, 0x74, 0x70,
...
func file_mls_database_intents_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mls_database_intents_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*UpdatePermissionData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mls_database_intents_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_mls_database_intents_proto_msgTypes[18].Exporter = func(v any, i int) any {
			switch v := v.(*UpdatePermissionData_V1); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mls_database_intents_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_mls_database_intents_proto_msgTypes[20].Exporter = func(v any, i int) any {
