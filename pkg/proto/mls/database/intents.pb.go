...
type PostCommitAction_Installation struct {
	...
	EncryptionType  message_contents.WelcomeEncryption `protobuf:"varint,3,opt,name=encryption_type,json=encryptionType,proto3,enum=xmtp.mls.message_contents.WelcomeEncryption" json:"encryption_type,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *PostCommitAction_Installation) GetEncryptionType() message_contents.WelcomeEncryption {
	if x != nil {
		return x.EncryptionType
	}
	return message_contents.WelcomeEncryption(0)
}
...
const file_mls_database_intents_proto_rawDesc = "" +
	"\n" +
	"\x1amls/database/intents.proto\x12\x11xmtp.mls.database\x1a%mls/message_contents/encryption.proto\"\x80\x01\n" +
	...
	"\rsend_welcomes\x18\x01 \x01(\v20.xmtp.mls.database.PostCommitAction.SendWelcomesH\x00R\fsendWelcomes\x1a\xb8\x01\n" +
	"\fInstallation\x12)\n" +
	"\x10installation_key\x18\x01 \x01(\fR\x0finstallationKey\x12&\n" +
	"\x0fhpke_public_key\x18\x02 \x01(\fR\rhpkePublicKey\x12U\n" +
	"\x0fencryption_type\x18\x03 \x01(\x0e2,.xmtp.mls.message_contents.WelcomeEncryptionR\x0eencryptionType\x1a\x8f\x01\n" +
	"\fSendWelcomes\x12V\n" +
...
var file_mls_database_intents_proto_goTypes = []any{
	...
	(message_contents.WelcomeEncryption)(0), // 24: xmtp.mls.message_contents.WelcomeEncryption
}
var file_mls_database_intents_proto_depIdxs = []int32{
	...
	24, // 16: xmtp.mls.database.PostCommitAction.Installation.encryption_type:type_name -> xmtp.mls.message_contents.WelcomeEncryption
