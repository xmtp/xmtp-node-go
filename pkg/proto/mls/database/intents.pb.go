...
const file_mls_database_intents_proto_rawDesc = "" +
	"\n" +
	"\x1amls/database/intents.proto\x12\x11xmtp.mls.database\x1a-mls/message_contents/wrapper_encryption.proto\x1a*mls/message_contents/welcome_pointer.proto\"\x80\x01\n" +
