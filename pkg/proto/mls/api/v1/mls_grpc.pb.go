...
const (
	...
	MlsApi_PublishCommitLogEntry_FullMethodName    = "/xmtp.mls.api.v1.MlsApi/PublishCommitLogEntry"
...
type MlsApiClient interface {
	...
	PublishCommitLogEntry(ctx context.Context, in *PublishCommitLogEntryRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *mlsApiClient) PublishCommitLogEntry(ctx context.Context, in *PublishCommitLogEntryRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, MlsApi_PublishCommitLogEntry_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MlsApiServer interface {
	...
	PublishCommitLogEntry(context.Context, *PublishCommitLogEntryRequest) (*emptypb.Empty, error)
...
func (UnimplementedMlsApiServer) PublishCommitLogEntry(context.Context, *PublishCommitLogEntryRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PublishCommitLogEntry not implemented")
}
...
func _MlsApi_PublishCommitLogEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PublishCommitLogEntryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MlsApiServer).PublishCommitLogEntry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MlsApi_PublishCommitLogEntry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MlsApiServer).PublishCommitLogEntry(ctx, req.(*PublishCommitLogEntryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MlsApi_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PublishCommitLogEntry",
			Handler:    _MlsApi_PublishCommitLogEntry_Handler,
		},
		{
