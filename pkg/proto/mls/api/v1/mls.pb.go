...
type WelcomeMessage_V1 struct {
	...
	Ciphersuite     message_contents1.WelcomeEncryption `protobuf:"varint,6,opt,name=ciphersuite,proto3,enum=xmtp.mls.message_contents.WelcomeEncryption" json:"ciphersuite,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *WelcomeMessage_V1) GetCiphersuite() message_contents1.WelcomeEncryption {
	if x != nil {
		return x.Ciphersuite
	}
	return message_contents1.WelcomeEncryption(0)
}
...
type WelcomeMessageInput_V1 struct {
	...
	Ciphersuite     message_contents1.WelcomeEncryption `protobuf:"varint,4,opt,name=ciphersuite,proto3,enum=xmtp.mls.message_contents.WelcomeEncryption" json:"ciphersuite,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *WelcomeMessageInput_V1) GetCiphersuite() message_contents1.WelcomeEncryption {
	if x != nil {
		return x.Ciphersuite
	}
	return message_contents1.WelcomeEncryption(0)
...
const file_mls_api_v1_mls_proto_rawDesc = "" +
	"\n" +
	"\x14mls/api/v1/mls.proto\x12\x0fxmtp.mls.api.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a message_contents/signature.proto\x1a%mls/message_contents/encryption.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xbe\x02\n" +
	"\x0eWelcomeMessage\x124\n" +
	"\x02v1\x18\x01 \x01(\v2\".xmtp.mls.api.v1.WelcomeMessage.V1H\x00R\x02v1\x1a\xea\x01\n" +
	"\x02V1\x12\x0e\n" +
	...
	"\x0fhpke_public_key\x18\x05 \x01(\fR\rhpkePublicKey\x12N\n" +
	"\vciphersuite\x18\x06 \x01(\x0e2,.xmtp.mls.message_contents.WelcomeEncryptionR\vciphersuiteB\t\n" +
	"\aversion\"\x99\x02\n" +
	"\x13WelcomeMessageInput\x129\n" +
	"\x02v1\x18\x01 \x01(\v2'.xmtp.mls.api.v1.WelcomeMessageInput.V1H\x00R\x02v1\x1a\xbb\x01\n" +
	"\x02V1\x12)\n" +
	"\x10installation_key\x18\x01 \x01(\fR\x0finstallationKey\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\x12&\n" +
	"\x0fhpke_public_key\x18\x03 \x01(\fR\rhpkePublicKey\x12N\n" +
	"\vciphersuite\x18\x04 \x01(\x0e2,.xmtp.mls.message_contents.WelcomeEncryptionR\vciphersuiteB\t\n" +
	"\aversion\"\xf4\x01\n" +
	"\fGroupMessage\x122\n" +
	...
	"\x18SubscribeWelcomeMessages\x120.xmtp.mls.api.v1.SubscribeWelcomeMessagesRequest\x1a\x1f.xmtp.mls.api.v1.WelcomeMessage\"-\x82\xd3\xe4\x93\x02':\x01*\"\"/mls/v1/subscribe-welcome-messages0\x01B\xc9\x01\x92A\x0f\x12\r\n" +
	"\x06MlsApi2\x031.0\n" +
...
var file_mls_api_v1_mls_proto_goTypes = []any{
	...
	(message_contents1.WelcomeEncryption)(0),                     // 35: xmtp.mls.message_contents.WelcomeEncryption
...
var file_mls_api_v1_mls_proto_depIdxs = []int32{
	...
	35, // 20: xmtp.mls.api.v1.WelcomeMessage.V1.ciphersuite:type_name -> xmtp.mls.message_contents.WelcomeEncryption
	35, // 21: xmtp.mls.api.v1.WelcomeMessageInput.V1.ciphersuite:type_name -> xmtp.mls.message_contents.WelcomeEncryption
