...
type PublishCommitLogEntryRequest struct {
	state                   protoimpl.MessageState `protogen:"open.v1"`
	GroupId                 []byte                 `protobuf:"bytes,1,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
...
func (x *PublishCommitLogEntryRequest) Reset() {
	*x = PublishCommitLogEntryRequest{}
	mi := &file_mls_api_v1_mls_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PublishCommitLogEntryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublishCommitLogEntryRequest) ProtoMessage() {}

func (x *PublishCommitLogEntryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_mls_api_v1_mls_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublishCommitLogEntryRequest.ProtoReflect.Descriptor instead.
func (*PublishCommitLogEntryRequest) Descriptor() ([]byte, []int) {
	return file_mls_api_v1_mls_proto_rawDescGZIP(), []int{22}
}

func (x *PublishCommitLogEntryRequest) GetGroupId() []byte {
	if x != nil {
		return x.GroupId
	}
	return nil
...
func (x *PublishCommitLogEntryRequest) GetEncryptedCommitLogEntry() []byte {
	if x != nil {
...
const file_mls_api_v1_mls_proto_rawDesc = "" +
	...
	"\tid_cursor\x18\x02 \x01(\x04R\bidCursor\"v\n" +
	"\x1cPublishCommitLogEntryRequest\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\fR\agroupId\x12;\n" +
	...
	"\x15PublishCommitLogEntry\x12-.xmtp.mls.api.v1.PublishCommitLogEntryRequest\x1a\x16.google.protobuf.Empty\"+\x82\xd3\xe4\x93\x02%:\x01*\" /mls/v1/publish-commit-log-entry\x12\x9b\x01\n" +
	"\x13BatchQueryCommitLog\x12+.xmtp.mls.api.v1.BatchQueryCommitLogRequest\x1a,.xmtp.mls.api.v1.BatchQueryCommitLogResponse\")\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/mls/v1/batch-query-commit-logB\xc9\x01\x92A\x0f\x12\r\n" +
	"\x06MlsApi2\x031.0\n" +
...
var file_mls_api_v1_mls_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_mls_api_v1_mls_proto_goTypes = []any{
	...
	(*PublishCommitLogEntryRequest)(nil),                         // 23: xmtp.mls.api.v1.PublishCommitLogEntryRequest
	(*QueryCommitLogRequest)(nil),                                // 24: xmtp.mls.api.v1.QueryCommitLogRequest
	(*QueryCommitLogResponse)(nil),                               // 25: xmtp.mls.api.v1.QueryCommitLogResponse
	(*BatchQueryCommitLogRequest)(nil),                           // 26: xmtp.mls.api.v1.BatchQueryCommitLogRequest
	(*BatchQueryCommitLogResponse)(nil),                          // 27: xmtp.mls.api.v1.BatchQueryCommitLogResponse
	(*WelcomeMessage_V1)(nil),                                    // 28: xmtp.mls.api.v1.WelcomeMessage.V1
	(*WelcomeMessageInput_V1)(nil),                               // 29: xmtp.mls.api.v1.WelcomeMessageInput.V1
	(*GroupMessage_V1)(nil),                                      // 30: xmtp.mls.api.v1.GroupMessage.V1
	(*GroupMessageInput_V1)(nil),                                 // 31: xmtp.mls.api.v1.GroupMessageInput.V1
	(*FetchKeyPackagesResponse_KeyPackage)(nil),                  // 32: xmtp.mls.api.v1.FetchKeyPackagesResponse.KeyPackage
	(*GetIdentityUpdatesResponse_NewInstallationUpdate)(nil),     // 33: xmtp.mls.api.v1.GetIdentityUpdatesResponse.NewInstallationUpdate
	(*GetIdentityUpdatesResponse_RevokedInstallationUpdate)(nil), // 34: xmtp.mls.api.v1.GetIdentityUpdatesResponse.RevokedInstallationUpdate
	(*GetIdentityUpdatesResponse_Update)(nil),                    // 35: xmtp.mls.api.v1.GetIdentityUpdatesResponse.Update
	(*GetIdentityUpdatesResponse_WalletUpdates)(nil),             // 36: xmtp.mls.api.v1.GetIdentityUpdatesResponse.WalletUpdates
	(*SubscribeGroupMessagesRequest_Filter)(nil),                 // 37: xmtp.mls.api.v1.SubscribeGroupMessagesRequest.Filter
	(*SubscribeWelcomeMessagesRequest_Filter)(nil),               // 38: xmtp.mls.api.v1.SubscribeWelcomeMessagesRequest.Filter
	(*message_contents.Signature)(nil),                           // 39: xmtp.message_contents.Signature
	(*message_contents1.CommitLogEntry)(nil),                     // 40: xmtp.mls.message_contents.CommitLogEntry
	(message_contents1.WelcomeWrapperAlgorithm)(0),               // 41: xmtp.mls.message_contents.WelcomeWrapperAlgorithm
	(*emptypb.Empty)(nil),                                        // 42: google.protobuf.Empty
}
var file_mls_api_v1_mls_proto_depIdxs = []int32{
	28, // 0: xmtp.mls.api.v1.WelcomeMessage.v1:type_name -> xmtp.mls.api.v1.WelcomeMessage.V1
	29, // 1: xmtp.mls.api.v1.WelcomeMessageInput.v1:type_name -> xmtp.mls.api.v1.WelcomeMessageInput.V1
	30, // 2: xmtp.mls.api.v1.GroupMessage.v1:type_name -> xmtp.mls.api.v1.GroupMessage.V1
	31, // 3: xmtp.mls.api.v1.GroupMessageInput.v1:type_name -> xmtp.mls.api.v1.GroupMessageInput.V1
	...
	32, // 8: xmtp.mls.api.v1.FetchKeyPackagesResponse.key_packages:type_name -> xmtp.mls.api.v1.FetchKeyPackagesResponse.KeyPackage
	39, // 9: xmtp.mls.api.v1.RevokeInstallationRequest.wallet_signature:type_name -> xmtp.message_contents.Signature
	36, // 10: xmtp.mls.api.v1.GetIdentityUpdatesResponse.updates:type_name -> xmtp.mls.api.v1.GetIdentityUpdatesResponse.WalletUpdates
	...
	37, // 18: xmtp.mls.api.v1.SubscribeGroupMessagesRequest.filters:type_name -> xmtp.mls.api.v1.SubscribeGroupMessagesRequest.Filter
	38, // 19: xmtp.mls.api.v1.SubscribeWelcomeMessagesRequest.filters:type_name -> xmtp.mls.api.v1.SubscribeWelcomeMessagesRequest.Filter
	16, // 20: xmtp.mls.api.v1.QueryCommitLogRequest.paging_info:type_name -> xmtp.mls.api.v1.PagingInfo
	40, // 21: xmtp.mls.api.v1.QueryCommitLogResponse.commit_log_entries:type_name -> xmtp.mls.message_contents.CommitLogEntry
	16, // 22: xmtp.mls.api.v1.QueryCommitLogResponse.paging_info:type_name -> xmtp.mls.api.v1.PagingInfo
	24, // 23: xmtp.mls.api.v1.BatchQueryCommitLogRequest.requests:type_name -> xmtp.mls.api.v1.QueryCommitLogRequest
	25, // 24: xmtp.mls.api.v1.BatchQueryCommitLogResponse.responses:type_name -> xmtp.mls.api.v1.QueryCommitLogResponse
	41, // 25: xmtp.mls.api.v1.WelcomeMessage.V1.wrapper_algorithm:type_name -> xmtp.mls.message_contents.WelcomeWrapperAlgorithm
	41, // 26: xmtp.mls.api.v1.WelcomeMessageInput.V1.wrapper_algorithm:type_name -> xmtp.mls.message_contents.WelcomeWrapperAlgorithm
	33, // 27: xmtp.mls.api.v1.GetIdentityUpdatesResponse.Update.new_installation:type_name -> xmtp.mls.api.v1.GetIdentityUpdatesResponse.NewInstallationUpdate
	34, // 28: xmtp.mls.api.v1.GetIdentityUpdatesResponse.Update.revoked_installation:type_name -> xmtp.mls.api.v1.GetIdentityUpdatesResponse.RevokedInstallationUpdate
	35, // 29: xmtp.mls.api.v1.GetIdentityUpdatesResponse.WalletUpdates.updates:type_name -> xmtp.mls.api.v1.GetIdentityUpdatesResponse.Update
	5,  // 30: xmtp.mls.api.v1.MlsApi.SendGroupMessages:input_type -> xmtp.mls.api.v1.SendGroupMessagesRequest
	6,  // 31: xmtp.mls.api.v1.MlsApi.SendWelcomeMessages:input_type -> xmtp.mls.api.v1.SendWelcomeMessagesRequest
	8,  // 32: xmtp.mls.api.v1.MlsApi.RegisterInstallation:input_type -> xmtp.mls.api.v1.RegisterInstallationRequest
	10, // 33: xmtp.mls.api.v1.MlsApi.UploadKeyPackage:input_type -> xmtp.mls.api.v1.UploadKeyPackageRequest
	11, // 34: xmtp.mls.api.v1.MlsApi.FetchKeyPackages:input_type -> xmtp.mls.api.v1.FetchKeyPackagesRequest
	13, // 35: xmtp.mls.api.v1.MlsApi.RevokeInstallation:input_type -> xmtp.mls.api.v1.RevokeInstallationRequest
	14, // 36: xmtp.mls.api.v1.MlsApi.GetIdentityUpdates:input_type -> xmtp.mls.api.v1.GetIdentityUpdatesRequest
	17, // 37: xmtp.mls.api.v1.MlsApi.QueryGroupMessages:input_type -> xmtp.mls.api.v1.QueryGroupMessagesRequest
	19, // 38: xmtp.mls.api.v1.MlsApi.QueryWelcomeMessages:input_type -> xmtp.mls.api.v1.QueryWelcomeMessagesRequest
	21, // 39: xmtp.mls.api.v1.MlsApi.SubscribeGroupMessages:input_type -> xmtp.mls.api.v1.SubscribeGroupMessagesRequest
	22, // 40: xmtp.mls.api.v1.MlsApi.SubscribeWelcomeMessages:input_type -> xmtp.mls.api.v1.SubscribeWelcomeMessagesRequest
	23, // 41: xmtp.mls.api.v1.MlsApi.PublishCommitLogEntry:input_type -> xmtp.mls.api.v1.PublishCommitLogEntryRequest
	26, // 42: xmtp.mls.api.v1.MlsApi.BatchQueryCommitLog:input_type -> xmtp.mls.api.v1.BatchQueryCommitLogRequest
	42, // 43: xmtp.mls.api.v1.MlsApi.SendGroupMessages:output_type -> google.protobuf.Empty
	42, // 44: xmtp.mls.api.v1.MlsApi.SendWelcomeMessages:output_type -> google.protobuf.Empty
	9,  // 45: xmtp.mls.api.v1.MlsApi.RegisterInstallation:output_type -> xmtp.mls.api.v1.RegisterInstallationResponse
	42, // 46: xmtp.mls.api.v1.MlsApi.UploadKeyPackage:output_type -> google.protobuf.Empty
	12, // 47: xmtp.mls.api.v1.MlsApi.FetchKeyPackages:output_type -> xmtp.mls.api.v1.FetchKeyPackagesResponse
	42, // 48: xmtp.mls.api.v1.MlsApi.RevokeInstallation:output_type -> google.protobuf.Empty
	15, // 49: xmtp.mls.api.v1.MlsApi.GetIdentityUpdates:output_type -> xmtp.mls.api.v1.GetIdentityUpdatesResponse
	18, // 50: xmtp.mls.api.v1.MlsApi.QueryGroupMessages:output_type -> xmtp.mls.api.v1.QueryGroupMessagesResponse
	20, // 51: xmtp.mls.api.v1.MlsApi.QueryWelcomeMessages:output_type -> xmtp.mls.api.v1.QueryWelcomeMessagesResponse
	3,  // 52: xmtp.mls.api.v1.MlsApi.SubscribeGroupMessages:output_type -> xmtp.mls.api.v1.GroupMessage
	1,  // 53: xmtp.mls.api.v1.MlsApi.SubscribeWelcomeMessages:output_type -> xmtp.mls.api.v1.WelcomeMessage
	42, // 54: xmtp.mls.api.v1.MlsApi.PublishCommitLogEntry:output_type -> google.protobuf.Empty
	27, // 55: xmtp.mls.api.v1.MlsApi.BatchQueryCommitLog:output_type -> xmtp.mls.api.v1.BatchQueryCommitLogResponse
...
func file_mls_api_v1_mls_proto_init() {
	...
	file_mls_api_v1_mls_proto_msgTypes[34].OneofWrappers = []any{
