...
var file_mls_message_contents_group_membership_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0xf4, 0x01, 0x0a, 0x1d,
...
var file_mls_message_contents_group_membership_proto_goTypes = []interface{}{
...
func file_mls_message_contents_group_membership_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mls_message_contents_group_membership_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
