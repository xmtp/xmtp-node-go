...
var file_mls_message_contents_group_mutable_metadata_proto_rawDesc = []byte{
	...
	0x78, 0x49, 0x64, 0x73, 0x42, 0xf9, 0x01, 0x0a, 0x1d, 0x63, 0x6f, 0x6d, 0x2e, 0x78, 0x6d, 0x74,
...
func file_mls_message_contents_group_mutable_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mls_message_contents_group_mutable_metadata_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_mls_message_contents_group_mutable_metadata_proto_msgTypes[1].Exporter = func(v any, i int) any {
