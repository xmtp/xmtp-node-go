...
var file_mls_message_contents_transcript_messages_proto_rawDesc = []byte{
	...
	0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0xf7, 0x01, 0x0a, 0x1d, 0x63, 0x6f, 0x6d, 0x2e, 0x78,
...
func file_mls_message_contents_transcript_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mls_message_contents_transcript_messages_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_mls_message_contents_transcript_messages_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_mls_message_contents_transcript_messages_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_mls_message_contents_transcript_messages_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*GroupUpdated_Inbox); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mls_message_contents_transcript_messages_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*GroupUpdated_MetadataFieldChange); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
