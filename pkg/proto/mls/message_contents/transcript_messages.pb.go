...
func file_mls_message_contents_transcript_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mls_message_contents_transcript_messages_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mls_message_contents_transcript_messages_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mls_message_contents_transcript_messages_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_mls_message_contents_transcript_messages_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
