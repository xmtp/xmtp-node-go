...
func file_mls_message_contents_content_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mls_message_contents_content_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mls_message_contents_content_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	file_mls_message_contents_content_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*MessageHistoryKeyType_Chacha20Poly1305)(nil),
	}
	file_mls_message_contents_content_proto_msgTypes[8].OneofWrappers = []interface{}{
