...
type MessageHistoryReply struct {
	...
	SigningKey *MessageHistoryKeyType `protobuf:"bytes,4,opt,name=signing_key,json=signingKey,proto3" json:"signing_key,omitempty"`
	// HMAC Signature of the message-bundle
	BundleHash []byte `protobuf:"bytes,5,opt,name=bundle_hash,json=bundleHash,proto3" json:"bundle_hash,omitempty"`
}
...
func (x *MessageHistoryReply) GetSigningKey() *MessageHistoryKeyType {
	if x != nil {
		return x.SigningKey
	}
	return nil
...
func (x *MessageHistoryReply) GetBundleHash() []byte {
	if x != nil {
		return x.BundleHash
	}
	return nil
...
var file_mls_message_contents_content_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x69, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x93,
	0x02, 0x0a, 0x13, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72,
	...
	,
	...
	0x01, 0x42, 0xec, 0x01, 0x0a, 0x1d, 0x63, 0x6f, 0x6d, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d,
	0x6c, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65,
	0x6e, 0x74, 0x73, 0x42, 0x0c, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74,
...
var file_mls_message_contents_content_proto_depIdxs = []int32{
	...
	4, // 7: xmtp.mls.message_contents.PlaintextEnvelope.V2.request:type_name -> xmtp.mls.message_contents.MessageHistoryRequest
	5, // 8: xmtp.mls.message_contents.PlaintextEnvelope.V2.reply:type_name -> xmtp.mls.message_contents.MessageHistoryReply
...
func file_mls_message_contents_content_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mls_message_contents_content_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_mls_message_contents_content_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_mls_message_contents_content_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_mls_message_contents_content_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_mls_message_contents_content_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*MessageHistoryReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mls_message_contents_content_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*MessageHistoryKeyType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mls_message_contents_content_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_mls_message_contents_content_proto_msgTypes[8].Exporter = func(v any, i int) any {
