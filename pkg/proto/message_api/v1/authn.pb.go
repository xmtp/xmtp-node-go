...
const file_message_api_v1_authn_proto_rawDesc = "" +
	...
	"walletAddr\x12\x1d\n" +
	"\n" +
	"created_ns\x18\x02 \x01(\x04R\tcreatedNsB\xd4\x01\n" +
	"\x17com.xmtp.message_api.v1B\n" +
	"AuthnProtoP\x01ZCgithub.com/xmtp/xmtp-node-go/pkg/proto/message_api/v1;message_apiv1\xa2\x02\x03XMX\xaa\x02\x12Xmtp.MessageApi.V1\xca\x02\x12Xmtp\\MessageApi\\V1\xe2\x02\x1eXmtp\\MessageApi\\V1\\GPBMetadata\xea\x02\x14Xmtp::MessageApi::V1b\x06proto3"
