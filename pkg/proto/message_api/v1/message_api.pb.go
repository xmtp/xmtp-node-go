...
var file_message_api_v1_message_api_proto_rawDesc = []byte{
	...
	0x42, 0xef, 0x01, 0x92, 0x41, 0x13, 0x12, 0x11, 0x0a, 0x0a, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
...
func file_message_api_v1_message_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_api_v1_message_api_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_message_api_v1_message_api_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Cursor); i {
			case 0:
				return &v.state
			case 1:
		...
		file_message_api_v1_message_api_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_message_api_v1_message_api_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_message_api_v1_message_api_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_message_api_v1_message_api_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_message_api_v1_message_api_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_message_api_v1_message_api_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_message_api_v1_message_api_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_message_api_v1_message_api_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_message_api_v1_message_api_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_message_api_v1_message_api_proto_msgTypes[11].Exporter = func(v any, i int) any {
