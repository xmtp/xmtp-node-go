...
type PrivatePreferencesActionMap struct {
	...
	Actions map[string]*message_contents.PrivatePreferencesAction `protobuf:"bytes,1,rep,name=actions,proto3" json:"actions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_keystore_api_v1_keystore_proto_rawDesc = []byte{
	...
	0x45, 0x53, 0x48, 0x5f, 0x50, 0x50, 0x50, 0x50, 0x10, 0x03, 0x42, 0xde, 0x01, 0x0a, 0x18, 0x63,
	...
	,
}
...
func file_keystore_api_v1_keystore_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_keystore_api_v1_keystore_proto_msgTypes[31].Exporter = func(v any, i int) any {
			switch v := v.(*PrivatePreferencesActionMap); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_keystore_api_v1_keystore_proto_msgTypes[47].Exporter = func(v any, i int) any {
		...
		file_keystore_api_v1_keystore_proto_msgTypes[50].Exporter = func(v any, i int) any {
