...
type SubscribeResponse_V1_Envelopes struct {
	...
	MutateId      uint64 `protobuf:"varint,2,opt,name=mutate_id,json=mutateId,proto3" json:"mutate_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SubscribeResponse_V1_Envelopes) GetMutateId() uint64 {
	if x != nil {
		return x.MutateId
	}
	return 0
...
const file_xmtpv4_message_api_message_api_proto_rawDesc = "" +
	...
	"\x11GetNewestEnvelope\x121.xmtp.xmtpv4.message_api.GetNewestEnvelopeRequest\x1a2.xmtp.xmtpv4.message_api.GetNewestEnvelopeResponse\"\x03\x88\x02\x01B\xe3\x01\n" +
	"\x1bcom.xmtp.xmtpv4.message_apiB\x0fMessageApiProtoP\x01Z9github.com/xmtp/xmtp-node-go/pkg/proto/xmtpv4/message_api\xa2\x02\x03XXM\xaa\x02\x16Xmtp.Xmtpv4.MessageApi\xca\x02\x16Xmtp\\Xmtpv4\\MessageApi\xe2\x02\"Xmtp\\Xmtpv4\\MessageApi\\GPBMetadata\xea\x02\x18Xmtp::Xmtpv4::MessageApib\x06proto3"
