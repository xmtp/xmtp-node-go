...
var file_message_contents_signature_proto_rawDesc = []byte{
	...
	0x42, 0x07, 0x0a, 0x05, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x42, 0xd5, 0x01, 0x0a, 0x19, 0x63, 0x6f,
	...
	0x72, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75,
...
func file_message_contents_signature_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_contents_signature_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_message_contents_signature_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_message_contents_signature_proto_msgTypes[2].Exporter = func(v any, i int) any {
