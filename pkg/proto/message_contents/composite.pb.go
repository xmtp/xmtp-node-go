...
var file_message_contents_composite_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0xd5, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e,
	0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x6e,
...
func file_message_contents_composite_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_contents_composite_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_message_contents_composite_proto_msgTypes[1].Exporter = func(v any, i int) any {
