...
func file_message_contents_private_preferences_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_message_contents_private_preferences_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_message_contents_private_preferences_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
