...
func (x *PrivatePreferencesAction) GetAllowInboxId() *PrivatePreferencesAction_AllowInboxId {
	if x, ok := x.GetMessageType().(*PrivatePreferencesAction_AllowInboxId_); ok {
...
func (x *PrivatePreferencesAction) GetDenyInboxId() *PrivatePreferencesAction_DenyInboxId {
	if x, ok := x.GetMessageType().(*PrivatePreferencesAction_DenyInboxId_); ok {
...
func file_message_contents_private_preferences_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_contents_private_preferences_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_message_contents_private_preferences_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_message_contents_private_preferences_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_message_contents_private_preferences_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_message_contents_private_preferences_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*PrivatePreferencesAction_AllowInboxId); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_contents_private_preferences_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*PrivatePreferencesAction_DenyInboxId); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_contents_private_preferences_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_message_contents_private_preferences_proto_msgTypes[7].Exporter = func(v any, i int) any {
