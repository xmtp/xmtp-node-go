...
var file_message_contents_message_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0xd3, 0x01,
	...
	0x73, 0x61, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x37, 0x67, 0x69, 0x74,
...
func file_message_contents_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_contents_message_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_message_contents_message_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_message_contents_message_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_message_contents_message_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_message_contents_message_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_message_contents_message_proto_msgTypes[5].Exporter = func(v any, i int) any {
