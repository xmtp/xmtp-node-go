...
func file_message_contents_content_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_contents_content_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_message_contents_content_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_message_contents_content_proto_msgTypes[2].Exporter = func(v any, i int) any {
