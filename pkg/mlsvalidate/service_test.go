...
func (m *MockedGRPCService) GetAssociationState(
	ctx context.Context,
	in *svc.GetAssociationStateRequest,
	opts ...grpc.CallOption,
) (*svc.GetAssociationStateResponse, error) {
	return nil, nil
}

func (m *MockedGRPCService) ValidateKeyPackages(
	ctx context.Context,
	req *svc.ValidateKeyPackagesRequest,
	opts ...grpc.CallOption,
) (*svc.ValidateKeyPackagesResponse, error) {
	args := m.Called(ctx, req)

	return args.Get(0).(*svc.ValidateKeyPackagesResponse), args.Error(1)
}

func (m *MockedGRPCService) ValidateGroupMessages(
	ctx context.Context,
	req *svc.ValidateGroupMessagesRequest,
	opts ...grpc.CallOption,
) (*svc.ValidateGroupMessagesResponse, error) {
	args := m.Called(ctx, req)

	return args.Get(0).(*svc.ValidateGroupMessagesResponse), args.Error(1)
}

func (m *MockedGRPCService) ValidateInboxIdKeyPackages(
	ctx context.Context,
	req *svc.ValidateKeyPackagesRequest,
	opts ...grpc.CallOption,
) (*svc.ValidateInboxIdKeyPackagesResponse, error) {
	args := m.Called(ctx, req)

	return args.Get(0).(*svc.ValidateInboxIdKeyPackagesResponse), args.Error(1)
}

func (m *MockedGRPCService) VerifySmartContractWalletSignatures(
	ctx context.Context,
...
func TestValidateInboxIdKeyPackages(t *testing.T) {
	...
	mockGrpc.On("ValidateInboxIdKeyPackages", ctx, mock.Anything).
		Return(&svc.ValidateInboxIdKeyPackagesResponse{Responses: []*svc.ValidateInboxIdKeyPackagesResponse_Response{&firstResponse}}, nil)
