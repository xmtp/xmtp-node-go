...
func WrapperAlgorithmFromProto(proto messageContentsProto.WelcomeWrapperAlgorithm) WrapperAlgorithm {
	...
	case messageContentsProto.WelcomeWrapperAlgorithm_WELCOME_WRAPPER_ALGORITHM_XWING_MLKEM_512:
		return AlgorithmXwingMlkem512
	}
	return AlgorithmCurve25519
}
...
func WrapperAlgorithmToProto(algorithm WrapperAlgorithm) messageContentsProto.WelcomeWrapperAlgorithm {
	...
	case AlgorithmXwingMlkem512:
		return messageContentsProto.WelcomeWrapperAlgorithm_WELCOME_WRAPPER_ALGORITHM_XWING_MLKEM_512
	default:
		return messageContentsProto.WelcomeWrapperAlgorithm_WELCOME_WRAPPER_ALGORITHM_CURVE25519
	}
}
