...
type AuthzOptions struct {
	DBDSN string `long:"authz-db-dsn" description:"Connection string DSN for the authz DB"`
}
...
type Options struct {
	...
	MessageDBDSN           string        `long:"message-db-dsn" description:"A Postgres database connection string DSN"`
